...
public class TestEmployee {
    public static void main(String[] args) {
        ...
        Interfaces.Employee[] employeesArray = new Interfaces.Employee[totalEmployees];
            ...
            switch (choice) {
                case 1:
                    ...
                    float basicSalary = sc.nextFloat();
                     Interfaces.PermanentEmployee permanentEmployee = new PermanentEmployee(id, name, basicSalary);
...
//                    (employeesArray[i] = new PermanentEmployee(id, name, basicSalary)).calculateSalary();
                ...
                case 2:
                    ...
                    float totalHours = sc.nextFloat();
                     Interfaces.ContractEmployee contractEmployee = new ContractEmployee(id, name, totalHours);
